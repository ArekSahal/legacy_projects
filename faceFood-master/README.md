...
Import required React Bootstrap components within ```src/Recipe.js``` file or your custom component files:
...
4. Add `// @flow` to any files you want to type check (for example, to `src/Recipe.js`).
